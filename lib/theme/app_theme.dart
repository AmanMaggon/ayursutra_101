...
class AppTheme {
  ...
  // Healthcare color palette based on design specifications
  ...
  static const Color errorLight = Color(0xFFD32F2F); // Medical red
  ...
  static const Color shadowLight = Color(0x0D000000); // Subtle shadows
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    cardTheme: CardTheme(
      color: cardLight,
      elevation: 2.0, // Maximum 2dp elevation
      shadowColor: shadowLight,
    ...
    // Bottom navigation for healthcare workflows
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        minimumSize: Size(88, 48), // Accessibility touch target
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(8.0),
        ),
        elevation: 2.0,
    ...
    // Typography for healthcare content
    ...
    // Progress indicator with Ayurvedic color coding
  ...
  /// Dark theme maintaining healthcare trust in low-light environments
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      bodyLarge: GoogleFonts.inter(
        ...
        color: textPrimary,
        letterSpacing: 0.5,
        height: 1.5, // Better readability for medical content
      ),
